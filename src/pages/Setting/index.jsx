...
function Setting() {
  ...
  return (
    <Box
      ...
      <Container>
        <Box sx={{ display: 'flex', gap: '1.2rem', marginBottom: '1.2rem' }}>
          <Button
            href="#profilepage"
            sx={{
              width: '3.4rem',
        ...
        <Box>
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', height: '3rem' }}>
              <Typography
                sx={{
                  color: 'gray',
                  weight: '700',
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              <Typography sx={{ color: 'common.white', weight: '700', fontSize: '1.3rem' }}>
                Stream audio only
              </Typography>
            ...
            <Box>
              ...
              <Typography
                sx={{ color: 'gray', weight: '700', fontSize: '1.1rem', marginBottom: '1.3rem' }}>
                2023.2023
              </Typography>
              <Typography sx={{ color: 'common.white', weight: '700', fontSize: '1.3rem' }}>
            ...
            <Typography
              ...
              <Typography
                sx={{ color: 'gray', weight: '700', fontSize: '1.1rem'}}>
