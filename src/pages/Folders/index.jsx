...
function Folders() {
  return (
    ...
    >
    <SwiperSlide>
    <AlbumLibraryCard image={folder} title="moods" desc="11 playlists" to='/'/>
    </SwiperSlide>
    <SwiperSlide>
    <AlbumLibraryCard image={folder} title="blends" desc="8 playlists" to='/'/>
    </SwiperSlide>
    <SwiperSlide>
    <AlbumLibraryCard image={folder} title="favs" desc="14 playlists" to='/'/>
    </SwiperSlide>
    <SwiperSlide>
    <AlbumLibraryCard image={folder} title="random?" desc="10 playlists" to='/'/>
    </SwiperSlide> 
    </Swiper>
    <Footer/>
    </Box>
