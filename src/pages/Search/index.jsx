...
function Search() { 
  return (
    ...
    <TextField
        variant="outlined"
        sx={{border:"2px solid #ffffff","& input::placeholder":{
          color:"#8A9A9D;",
          fontSize:"1.3rem",
          fontFamily: 'Century Gothic'
        },"& fieldset": { border: 'none' },borderRadius:"2.3rem",width:"90%",padding:"0px",color:"#8A9A9D;",
        fontSize:"1.3rem",
        fontFamily: 'Century Gothic',margin:"2rem 0 4rem 2rem",
            "& .MuiInputLabel-root":
            {
                color:"#8A9A9D;",
                fontSize:"1.3rem",
